...
gwas_params="--gwas_id_list ${gwas_id_list} --gwas_dir ${gwas_dir} --gwas_meta ${gwas_meta} --ld_meta ${ld_meta} --gwas_column_matching ${gwas_column_matching} --run_single_gene ${run_single_gene} --run_v39_genes ${run_v39_genes} --strong_only ${strong_only} --p_threshold ${p_threshold}"
