...
reference_dir=/oak/stanford/groups/smontgom/dnachun/data/gtex/v10/data/sprint_references
reference_fasta=unified_masked_genome/Homo_sapiens_assembly38_noALT_noHLA_noDecoy.fasta
masked_genome_dir=unified_masked_genome
splicesites=gencode.v47.annotation.hisat2_splice_sites.txt
