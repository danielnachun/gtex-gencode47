ld_region_list="/oak/stanford/groups/smontgom/dnachun/data/gtex/v10/data/pecotmr_references/regions_test.bed"
...
output_dir="/oak/stanford/groups/smontgom/dnachun/data/gtex/v10/output/coloc_test"
