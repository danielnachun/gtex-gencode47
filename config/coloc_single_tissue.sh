...
gwas_meta="/oak/stanford/groups/smontgom/dnachun/data/gtex/v10/data/pecotmr_references/barberia_simplified_gwas_metadata.txt"
ld_meta="/oak/stanford/groups/smontgom/dnachun/data/gtex/v10/data/pecotmr_references/ld_blocks_gtex_eur/ld_metadata.tsv"
gwas_column_matching="/oak/stanford/groups/smontgom/dnachun/data/gtex/v10/data/pecotmr_references/barberia_gtex_column_matching.yml"
