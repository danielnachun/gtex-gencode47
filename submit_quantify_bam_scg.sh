...
# sample args
bam_dir=/oak/stanford/groups/smontgom/dnachun/data/gtex/v10/test_workflow/output_kate/genome_bam
...
output_dir=/oak/stanford/groups/smontgom/dnachun/data/gtex/v10/test_workflow/output_fixed_rnaseqqc
